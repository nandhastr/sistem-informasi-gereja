    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="id_lingkungan" name="id_lingkungan"
                        value="<?php echo $data_cek['id_lingkungan']; ?>" readonly />
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama_lingkungan" name="nama_lingkungan"
                        value="<?php echo $data_cek['nama_lingkungan']; ?>" />
                </div>
            </div>
